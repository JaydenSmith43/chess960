...
partial class FormLauncher
{
	...
	private void InitializeComponent()
	{
		...
		// btnClassicChessPvP
		// 
		btnClassicChessPvP.BackColor = Color.DodgerBlue;
		btnClassicChessPvP.FlatAppearance.BorderColor = Color.FromArgb(255, 128, 128);
		btnClassicChessPvP.FlatAppearance.BorderSize = 0;
		btnClassicChessPvP.FlatStyle = FlatStyle.Flat;
		btnClassicChessPvP.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point);
		btnClassicChessPvP.ForeColor = Color.White;
		btnClassicChessPvP.Location = new Point(266, 246);
		btnClassicChessPvP.Margin = new Padding(5);
		...
		btnPlayerVsAI.Margin = new Padding(5);
		...
		btnAIVsAI.Margin = new Padding(5);
		...
		btnJoinServer.Margin = new Padding(5);
		...
		btnHostServer.Margin = new Padding(5);
		...
		// btnChess960Pvp
		// 
		btnChess960Pvp.BackColor = Color.DodgerBlue;
		btnChess960Pvp.FlatAppearance.BorderColor = Color.FromArgb(255, 128, 128);
		btnChess960Pvp.FlatAppearance.BorderSize = 0;
		btnChess960Pvp.FlatStyle = FlatStyle.Flat;
		btnChess960Pvp.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point);
		btnChess960Pvp.ForeColor = Color.White;
		btnChess960Pvp.Location = new Point(266, 198);
		btnChess960Pvp.Margin = new Padding(5);
		btnChess960Pvp.Name = "btnChess960Pvp";
		btnChess960Pvp.Size = new Size(176, 38);
		btnChess960Pvp.TabIndex = 3;
		btnChess960Pvp.Text = "Chess960 (PvP)";
		btnChess960Pvp.UseVisualStyleBackColor = false;
		btnChess960Pvp.Click += btnChess960_Click;
		// 
		// FormLauncher
		// 
    ...
    private Button btnClassicChessPvP;
	private Button btnChess960Pvp;
